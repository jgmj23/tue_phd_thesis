...
\begin{itemize}
\item \textbf{Chapter~\ref{ch:rdma}} treats the infrastructure as an attack surface, spanning device-level side channels through to the ordering- and timing-related risks of RDMA over high-throughput optical fabrics, addresses RQ4, and presents P7.
