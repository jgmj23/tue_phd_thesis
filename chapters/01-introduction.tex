...
\medskip
\textbf{Chapter~\ref{ch:background}} establishes the two threads common to every contribution: the cross-layer method used to analyze them, and the DPU substrate on which they are built and observed. Topic-specific background is developed in each paper-centric chapter where it is needed.
...
\item \textbf{Chapter~\ref{ch:ai-pipelines}} discusses the application of post-quantum mechanisms to secure end-to-end AI pipelines, addresses RQ1, and presents P6.
\end{itemize}

\medskip
\textbf{Part~III --- Programmable Datacenter Infrastructure} addresses the programmable network substrate on which both the post-quantum and quantum mechanisms must ultimately run, exposing the cross-layer interactions at the heart of RQ4.
\begin{itemize}
