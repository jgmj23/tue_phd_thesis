...
Status confirmed by the user: P1, P2, P3, P7, and P8 were accepted. P1, P2,
P7, and P8 were presented, while P3 will be presented at its forthcoming
conference. P6 remains under review at ICA3PP. The journal papers retain their
individual published or in-review status.
...
| Quantum photonics | "Free Spectral Range Stability under Linear Thermal Tuning in a Dual-Coupled Microring Resonator" | accepted and presented | Source repository supplied by user: `https://github.com/jgmj23/ICSEE26---FSRstableDCM`. Local final PDF and presentation also found in `/Users/jomeyer/Documents/Projects/DCM/ICSEE26/`. |
| Quantum photonics | "Simulation-Driven Optimization of Dual-Coupled Micro-Ring Entanglement Sources for Quantum Networks" | accepted and presented / invited | Source in `/Users/jomeyer/Documents/Projects/DCM/ICTON26_DCM/main.tex`; bibliography in `/Users/jomeyer/Documents/Projects/DCM/ICTON26_DCM/refs.bib`. |
| Confidential AI / DPU observability | "Intrusion Detection for Confidential AI Training Clusters: A Cross-Layer Observability Framework" | accepted and presented / invited | Source in `/Users/jomeyer/Documents/Projects/ConfidentialCompute/agents/paperA_icton/Overleaf/1_main.tex`; bibliography in `/Users/jomeyer/Documents/Projects/ConfidentialCompute/agents/paperA_icton/Overleaf/references.bib`. |
| Optical/RDMA security | "Exploiting Cross-QP Ordering in RDMA over Optical Fabrics" | accepted and presented / invited | Candidate latest source in `/Users/jomeyer/Documents/Projects/ICTON26_RDMA_Ordering/Paper/1_main.tex`; bibliography in `/Users/jomeyer/Documents/Projects/ICTON26_RDMA_Ordering/Paper/references.bib`. Older parallel source also exists under `icton26_rdma/`. |
...
| QKD/DPU | "QKD Post-Processing Offload on BlueField-3 DPUs: Towards Quantum-Secured RDMA in Datacenter Fabrics" | accepted; to be presented (IEEE Quantum Week / QCE, Toronto) | Source in `/Users/jomeyer/Documents/Projects/QKD_DPU_QCE26/paper/paper.tex`; bibliography in `/Users/jomeyer/Documents/Projects/QKD_DPU_QCE26/paper/bibliography.bib`. |
...
| "Real-Time Post-Quantum Secured Image Pipeline on NVIDIA BlueField-3 DPU" | supplied 2026-06-28; in review at ICA3PP; review manuscript PDF | `source-materials/papers/camera-ready/EDGEAI.pdf` |
...
| "QKD Post-Processing Offload on BlueField-3 DPUs: Towards Quantum-Secured RDMA in Datacenter Fabrics" | supplied 2026-06-28; accepted and to be presented at IEEE Quantum Week (QCE, Toronto) | `source-materials/papers/camera-ready/QKD_PostProc_DPUs.pdf` |
...
context and the paper's contribution to the thesis, included paper, post-paper
discussion, and link to the next chapter.
...
| Post-Quantum Cryptography in Programmable Network Infrastructure | Post-Quantum Security for Edge AI Pipelines | "Securing Edge AI Pipelines: Offloading Image I/O and Post-Quantum Cryptography to DPUs". Under review at ICA3PP. |
...
- All nine thesis-body manuscripts now have a local PDF. P5 (Networking
  Letters), P6 (ICA3PP), and P9 (TIFS) remain in review; replace those
  manuscript PDFs with final publication versions if they are accepted.
