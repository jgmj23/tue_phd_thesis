...
- Removed the pre-existing `% TODO: Record the author's specific contributions...` comments from both chapters, per the `AGENTS.md` rule against per-author contribution statements.
