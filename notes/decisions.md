...
- Organize the thesis as a paper-centric compilation with five narrative parts: thesis frame, quantum photonic and quantum-secured network foundations, DPU/PQC infrastructure, datacenter fabric and confidential AI security, and synthesis. Each paper-bearing chapter should wrap the included manuscript with motivation, research-question mapping, publication context, author contribution, post-paper discussion, and a transition to the next chapter.
