...
| `006-collect-camera-ready-manuscripts` | [#6](https://github.com/jgmj23/tue_phd_thesis/issues/6) | Partially collected | Six supplied PDFs were normalized under ignored `source-materials/papers/camera-ready/`; remaining manuscript gaps are tracked in the issue and inventory. |
