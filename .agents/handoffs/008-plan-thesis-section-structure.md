...
Each paper-bearing chapter uses the same wrapper pattern: motivation, relation to research questions, publication context and the paper's contribution to the thesis, included paper, post-paper discussion, and transition to the next chapter.
...
- The Edge AI paper remains under review at ICA3PP; update its status and manuscript PDF after a decision.
